...
set(OMR_TEST_INTERPRETER OFF CACHE BOOL "Enable building the test treeInterpreter")
...
if(NOT OMR_COMPILER)
	...
	if(OMR_TEST_INTERPRETER)
		message(FATAL_ERROR "OMR_TEST_INTERPRETER is enabled but OMR_COMPILER is not enabled")
	endif()
endif()

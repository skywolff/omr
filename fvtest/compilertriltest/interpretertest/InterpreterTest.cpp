 ...
 */
class InterpreterTest : public TRTest::JitOptTest
   {
   ...
   InterpreterTest()
      ...
      addOptimization(OMR::treeInterpreter);
      }
 ...
 */
TEST_F(InterpreterTest, FoldDoesntHappen) {
   auto* inputTrees = "(method return=Int64 args=[Int32]  "
                       ...
                       "    (iu2l (iload parm=0))))))      "; 
   inputTrees = "(method return=Int64  "
                       " (block                            "
                       "  (lreturn                         "
                       "   (ladd                           " 
                       "    (lconst 0x2)                   "
